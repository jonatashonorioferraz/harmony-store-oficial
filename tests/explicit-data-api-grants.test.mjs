...
const internalReceiptDeletion = await readFile(
  new URL('../supabase/migrations/20260719235500_delete_internal_test_receipts.sql', import.meta.url),
  'utf8',
);
const productionColors = await readFile(
...
const primaryRequestEdit = await readFile(
  new URL('../supabase/migrations/20260720124500_primary_admin_full_request_edit.sql', import.meta.url),
  'utf8',
);
const separatedCatalogs = await readFile(
  new URL('../supabase/migrations/20260720143000_separate_production_internal_catalogs.sql', import.meta.url),
  'utf8',
);
const individualPaymentCycles = await readFile(
  new URL('../supabase/migrations/20260721195736_individual_production_payment_cycles.sql', import.meta.url),
  'utf8',
);
const appUsage = await readFile(
  new URL('../supabase/migrations/20260725174925_collaborator_app_usage.sql', import.meta.url),
  'utf8',
);
const bills = await readFile(
  new URL('../supabase/migrations/20260725212141_admin_bills.sql', import.meta.url),
  'utf8',
);
const billReactivation = await readFile(
  new URL('../supabase/migrations/20260727160000_bill_reactivation.sql', import.meta.url),
  'utf8',
);
const billDueDateCorrection = await readFile(
  new URL('../supabase/migrations/20260819190000_bill_due_date_correction_reactivation.sql', import.meta.url),
  'utf8',
);
const separationCheckup = await readFile(
  new URL('../supabase/migrations/20260807113000_separation_checkup_and_replenishment.sql', import.meta.url),
  'utf8',
);
const productionInventory = await readFile(
  new URL('../supabase/migrations/20260809103000_production_inventory.sql', import.meta.url),
  'utf8',
);
const productionInventoryBoxes = await readFile(
  new URL('../supabase/migrations/20260809193000_production_inventory_unique_boxes.sql', import.meta.url),
  'utf8',
);
const productionInventoryTransfers = await readFile(
...
const internalReceiptReconciliation = await readFile(
  new URL('../supabase/migrations/20260810204500_internal_supply_receipt_reconciliation.sql', import.meta.url),
  'utf8',
);
const inventoryAiIntelligence = await readFile(
  new URL('../supabase/migrations/20260811230510_inventory_ai_intelligence.sql', import.meta.url),
  'utf8',
);
const adminAgendaHarmony = await readFile(
  new URL('../supabase/migrations/20260812130000_admin_agenda_harmony.sql', import.meta.url),
  'utf8',
);
const adminAgendaProductionOrderState = await readFile(
  new URL('../supabase/migrations/20260812183000_admin_agenda_production_order_state.sql', import.meta.url),
  'utf8',
);
const shippingPlanning = await readFile(
  new URL('../supabase/migrations/20260812223000_shipping_planning.sql', import.meta.url),
  'utf8',
);
const shippingExclusiveProducts = await readFile(
  new URL('../supabase/migrations/20260813103000_shipping_exclusive_product_catalog.sql', import.meta.url),
  'utf8',
);
const shippingColorCombinations = await readFile(
  new URL('../supabase/migrations/20260813210448_shipping_color_combinations.sql', import.meta.url),
  'utf8',
);
const shippingCompositeKits = await readFile(
  new URL('../supabase/migrations/20260814170000_shipping_composite_kits_inventory_reservations.sql', import.meta.url),
  'utf8',
);
const shippingAvailabilityProjection = await readFile(
  new URL('../supabase/migrations/20260814173000_shipping_inventory_availability_projection.sql', import.meta.url),
  'utf8',
);
const transferCenter = await readFile(
