...
test('dashboard is isolated, responsive and available offline',()=>{
  ...
  assert.match(worker,/shopee-intelligence\.css\?v=25\.88/);assert.match(worker,/shopee-intelligence\.js\?v=25\.88/);assert.match(worker,/harmony-store-v25-89-r1/);
  assert.equal(JSON.parse(pkg).version,'25.89.0');
});
