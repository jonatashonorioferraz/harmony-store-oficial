...
export const STANDARD_WORKFLOW: readonly StageDefinition[] = [
  ...
  { key: "visual-production-1", agentRole: "virtual-photographer", dependencies: ["art-direction"], allowedInputs: ["art-direction.briefs.0", "imageRevisionFeedback.visual-production-1", "assets"], usesExcellence: true },
  { key: "visual-production-2", agentRole: "virtual-photographer", dependencies: ["visual-production-1"], allowedInputs: ["art-direction.briefs.1", "imageRevisionFeedback.visual-production-2", "assets"], usesExcellence: true },
  { key: "visual-production-3", agentRole: "virtual-photographer", dependencies: ["visual-production-2"], allowedInputs: ["art-direction.briefs.2", "imageRevisionFeedback.visual-production-3", "assets"], usesExcellence: true },
  { key: "visual-production-4", agentRole: "virtual-photographer", dependencies: ["visual-production-3"], allowedInputs: ["art-direction.briefs.3", "imageRevisionFeedback.visual-production-4", "assets"], usesExcellence: true },
  { key: "visual-production-5", agentRole: "virtual-photographer", dependencies: ["visual-production-4"], allowedInputs: ["art-direction.briefs.4", "imageRevisionFeedback.visual-production-5", "assets"], usesExcellence: true },
  { key: "visual-production-6", agentRole: "virtual-photographer", dependencies: ["visual-production-5"], allowedInputs: ["art-direction.briefs.5", "imageRevisionFeedback.visual-production-6", "product.approvedFacts", "assets"], usesExcellence: true },
