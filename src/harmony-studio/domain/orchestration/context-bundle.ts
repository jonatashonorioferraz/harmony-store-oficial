...
export function buildContextBundle(input: { stageKey: StageKey; agentRole: AgentRole; allowedInputs: string[]; availableData: Record<string, unknown>; knowledge: AgentKnowledgeVersion; excellence: ExcellenceItem[]; visualReferences?: VisualReference[]; visualStandard?: VisualStandard | null }): ContextBundle {
