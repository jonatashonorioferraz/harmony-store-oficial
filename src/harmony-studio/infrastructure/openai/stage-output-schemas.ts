...
export const STAGE_OUTPUT_SCHEMAS: Record<Exclude<StageKey, "visual-production">, Record<string, unknown>> = {
  ...
  "art-direction": object({ brief: object({ objective: { type: "string" }, composition: { type: "string" }, lighting: { type: "string" }, restrictions: strings }) }),
  ...
  "quality-gate": object({ release: { type: "string", enum: ["approved", "reprocess", "rejected"] }, reprocessStage: { type: ["string", "null"] }, reasons: strings }),
};
