const CACHE='harmony-store-v5';
const SHELL=['./','./index.html','./styles.css','./app.js','./pwa.js','./enhancements.js','./manifest.webmanifest','./logo.jpg','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
