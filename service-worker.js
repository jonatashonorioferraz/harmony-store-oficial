const CACHE='harmony-store-v25-29';
const SHELL=['./','./index.html','./styles.css','./intelligence.css','./production-receipts.css?v=25.26','./production-orders.css?v=25.28','./notifications.css?v=25.27','./product-visibility.css','./internal-supplies.css?v=25.22','./request-hub.css?v=25.25','./app.js?v=25.29','./product-visibility.js','./pwa.js?v=25.27','./daily-messages.js','./enhancements.js','./intelligence.js','./production-receipts.js?v=25.26','./production-orders.js?v=25.28','./notifications.js','./internal-supplies.js?v=25.24','./help-center.js','./system-health.js?v=25.29','./request-hub.js?v=25.25','./CHANGELOG.md','./manifest.webmanifest','./logo.jpg','./brand-mark.png','./mascote-artesa.png','./icon-192-v2.png','./icon-512-v2.png','./apple-touch-icon-v2.png','./notification-badge.svg'];
