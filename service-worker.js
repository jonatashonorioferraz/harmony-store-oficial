const CACHE='harmony-store-v25-23';
const SHELL=['./','./index.html','./styles.css','./intelligence.css','./production-receipts.css?v=25.23','./production-orders.css?v=25.20','./notifications.css','./product-visibility.css','./internal-supplies.css?v=25.22','./app.js?v=25.23','./product-visibility.js','./pwa.js','./daily-messages.js','./enhancements.js','./intelligence.js','./production-receipts.js?v=25.23','./production-orders.js?v=25.20','./notifications.js','./internal-supplies.js?v=25.22','./help-center.js','./system-health.js?v=25.23','./CHANGELOG.md','./manifest.webmanifest','./logo.jpg','./brand-mark.png','./mascote-artesa.png','./icon-192-v2.png','./icon-512-v2.png','./apple-touch-icon-v2.png','./notification-badge.svg'];
