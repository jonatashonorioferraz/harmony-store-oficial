const CACHE='harmony-store-v6';
const SHELL=['./','./index.html','./styles.css','./app.js','./pwa.js','./enhancements.js','./manifest.webmanifest','./logo.jpg','./brand-mark.png','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
