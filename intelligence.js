...
function bindIntelligence(){
  document.querySelectorAll('[data-intel-tab]').forEach(button=>button.onclick=()=>{if(['materials','ecommerce'].includes(button.dataset.intelTab)&&button.dataset.intelTab!==BI.tab)BI.productId='';BI.tab=button.dataset.intelTab;rerender()});
