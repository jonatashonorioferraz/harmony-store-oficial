...
const generatedColumns = {
  ...
  shipping_plans: ['protocol'],
  shipping_inventory_requests: ['protocol'],
  production_inventory_entries: ['protocol'],
  production_inventory_movements: ['protocol'],
  production_inventory_label_prints: ['protocol'],
  inventory_ai_settings: ['updated_at'],
  shopee_sales_daily: ['id'],
  shopee_traffic_sources: ['id'],
  shopee_product_performance: ['id'],
  shopee_product_funnel_daily: ['id'],
  shopee_promotion_metrics: ['id'],
  shopee_promotion_campaigns: ['id'],
  shopee_ai_settings: ['updated_at'],
  admin_agenda_tasks: ['protocol', 'updated_at'],
  admin_agenda_task_events: ['id'],
  admin_agenda_reminder_deliveries: ['id', 'updated_at'],
  admin_agenda_ai_settings: ['updated_at'],
  admin_agenda_production_order_states: ['updated_at'],
  admin_agenda_production_order_events: ['id'],
