...
Deno.serve(async request => {
  ...
  try {
    ...
    items.push({ key: "version", label: "Versão publicada", status: "green", value: "v25.23", detail: "Agendas individuais de corte e pagamento da produção.", checked_at: checkedAt });
